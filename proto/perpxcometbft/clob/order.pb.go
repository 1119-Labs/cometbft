...
// source: perpxcometbft/clob/order.proto
...
func (Order_Side) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_8a678233e6e032d3, []int{6, 0}
}
...
func (Order_TimeInForce) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_8a678233e6e032d3, []int{6, 1}
}
...
func (*OrderId) Descriptor() ([]byte, []int) {
	return fileDescriptor_8a678233e6e032d3, []int{0}
}
...
func (*OrdersFilledDuringLatestBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_8a678233e6e032d3, []int{1}
}
...
func (*PotentiallyPrunableOrders) Descriptor() ([]byte, []int) {
	return fileDescriptor_8a678233e6e032d3, []int{2}
}
...
func (*OrderFillState) Descriptor() ([]byte, []int) {
	return fileDescriptor_8a678233e6e032d3, []int{3}
}
...
func (*StatefulOrderTimeSliceValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_8a678233e6e032d3, []int{4}
}
...
func (*StatefulOrderPlacement) Descriptor() ([]byte, []int) {
	return fileDescriptor_8a678233e6e032d3, []int{5}
}
...
type Order struct {
	...
	Side    Order_Side `protobuf:"varint,2,opt,name=side,proto3,enum=perpxcometbft.clob.Order_Side" json:"side,omitempty"`
	...
	TimeInForce Order_TimeInForce `protobuf:"varint,7,opt,name=time_in_force,json=timeInForce,proto3,enum=perpxcometbft.clob.Order_TimeInForce" json:"time_in_force,omitempty"`
...
func (*Order) Descriptor() ([]byte, []int) {
	return fileDescriptor_8a678233e6e032d3, []int{6}
}
...
func init() {
	proto.RegisterEnum("perpxcometbft.clob.Order_Side", Order_Side_name, Order_Side_value)
	proto.RegisterEnum("perpxcometbft.clob.Order_TimeInForce", Order_TimeInForce_name, Order_TimeInForce_value)
	proto.RegisterType((*OrderId)(nil), "perpxcometbft.clob.OrderId")
	proto.RegisterType((*OrdersFilledDuringLatestBlock)(nil), "perpxcometbft.clob.OrdersFilledDuringLatestBlock")
	proto.RegisterType((*PotentiallyPrunableOrders)(nil), "perpxcometbft.clob.PotentiallyPrunableOrders")
	proto.RegisterType((*OrderFillState)(nil), "perpxcometbft.clob.OrderFillState")
	proto.RegisterType((*StatefulOrderTimeSliceValue)(nil), "perpxcometbft.clob.StatefulOrderTimeSliceValue")
	proto.RegisterType((*StatefulOrderPlacement)(nil), "perpxcometbft.clob.StatefulOrderPlacement")
	proto.RegisterType((*Order)(nil), "perpxcometbft.clob.Order")
}

func init() { proto.RegisterFile("perpxcometbft/clob/order.proto", fileDescriptor_8a678233e6e032d3) }

var fileDescriptor_8a678233e6e032d3 = []byte{
	...
	,
}
