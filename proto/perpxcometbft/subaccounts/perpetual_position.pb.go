...
// source: perpxcometbft/subaccounts/perpetual_position.proto

package subaccounts

import (
	fmt "fmt"
	github_com_cometbft_cometbft_proto_perpxcometbft_gotypes "github.com/cometbft/cometbft/proto/perpxcometbft/gotypes"
...
type PerpetualPosition struct {
	...
	Quantums github_com_cometbft_cometbft_proto_perpxcometbft_gotypes.SerializableInt `protobuf:"bytes,2,opt,name=quantums,proto3,customtype=github.com/cometbft/cometbft/proto/perpxcometbft/gotypes.SerializableInt" json:"quantums"`
	// The funding_index of the `Perpetual` the last time this position was
	// settled.
	FundingIndex github_com_cometbft_cometbft_proto_perpxcometbft_gotypes.SerializableInt `protobuf:"bytes,3,opt,name=funding_index,json=fundingIndex,proto3,customtype=github.com/cometbft/cometbft/proto/perpxcometbft/gotypes.SerializableInt" json:"funding_index"`
}
...
func (*PerpetualPosition) Descriptor() ([]byte, []int) {
	return fileDescriptor_01e1455dd65cba8b, []int{0}
}
...
func init() {
	proto.RegisterType((*PerpetualPosition)(nil), "perpxcometbft.subaccounts.PerpetualPosition")
}

func init() {
	proto.RegisterFile("perpxcometbft/subaccounts/perpetual_position.proto", fileDescriptor_01e1455dd65cba8b)
}

var fileDescriptor_01e1455dd65cba8b = []byte{
	// 267 bytes of a gzipped FileDescriptorProto
	,
}
